...
model3 = XGBRegressor(learning_rate=0.05, random_state=3, n_estimators=800, subsample=0.8, 
...
newsub.to_csv('full.csv', index=False)

newsub['visitors'] = 0.6*newsub['visitors_x'] + 0.1*newsub['visitors_y']*0.8 + .3 *newsub['visitors']*1.3

newsub[['id', 'visitors']].to_csv('submission700.csv', index=False)